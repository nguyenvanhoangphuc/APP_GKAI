    ...
    <div
      ...
      <div id="my-scroll" style="margin: 0px 14px 0 14px;">
        <ul class="nav-list" style="overflow: visible;">
          ...
          <span>
            <li>
              <router-link class="links" data-path="cifar-recognition" :to="{ name: 'CifarRecognition' }"><i class="fa-solid fa-fan"></i><span class="links_name">Cifars Recognition</span></router-link>
            </li>
          </span>
