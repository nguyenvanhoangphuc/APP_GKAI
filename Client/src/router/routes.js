...
import CifarRecognition from '@/components/user/cifar-recognition/CifarRecognition'
...
const routes = [
    ...
    { path: '/reset-password', component: UserResetPassword, name: 'UserResetPassword', beforeEnter: loggedUser },
    {
        ...
        children: [
            ...
            { path: 'cifar-recognition', name: 'CifarRecognition', component: CifarRecognition },
